...
def test_smorf_taxonomy():
    taxonomy_file = smorf_taxonomy('./tests/test_taxonomy.db','./tests/alignment.tsv',os.path.dirname(os.path.realpath(__file__)))
...
deep_lca_taxonomy = []
def test_deep_lca():
    deep_lca('./tests/test_taxonomy.db',os.path.dirname(os.path.realpath(__file__)),'./tests/alignment.tsv',os.path.dirname(os.path.realpath(__file__)))
